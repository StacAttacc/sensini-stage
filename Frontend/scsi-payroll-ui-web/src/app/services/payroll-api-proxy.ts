...
export class LoginService {
     ...
     * @return Success
     */
    login(body: string | undefined): Observable<FirebaseToken> {
        let url_ = this.baseUrl + "/api/users/login/login";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<FirebaseToken>;
                }
            } else
                return _observableThrow(response_) as any as Observable<FirebaseToken>;
        }));
    }

    protected processLogin(response: HttpResponseBase): Observable<FirebaseToken> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : jsonParse(_responseText, this.jsonParseReviver);
            result200 = FirebaseToken.fromJS(resultData200, _mappings);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class FirebaseToken implements IFirebaseToken {
    readonly issuer?: string | undefined;
    readonly subject?: string | undefined;
    readonly audience?: string | undefined;
    readonly expirationTimeSeconds?: number;
    readonly issuedAtTimeSeconds?: number;
    readonly uid?: string | undefined;
    readonly tenantId?: string | undefined;
    readonly claims?: { [key: string]: any; } | undefined;

    constructor(data?: IFirebaseToken) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any, _mappings?: any) {
        if (_data) {
            ...
            (<any>this).audience = _data["audience"];
            (<any>this).expirationTimeSeconds = _data["expirationTimeSeconds"];
            (<any>this).issuedAtTimeSeconds = _data["issuedAtTimeSeconds"];
            (<any>this).uid = _data["uid"];
            (<any>this).tenantId = _data["tenantId"];
            if (_data["claims"]) {
                (<any>this).claims = {} as any;
                for (let key in _data["claims"]) {
                    if (_data["claims"].hasOwnProperty(key))
                        (<any>(<any>this).claims)![key] = _data["claims"][key];
                }
            }
        }
    }

    static fromJS(data: any, _mappings?: any): FirebaseToken | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<FirebaseToken>(data, _mappings, FirebaseToken);
    }
    ...
    toJSON(data?: any) {
        ...
        data["expirationTimeSeconds"] = this.expirationTimeSeconds;
        data["issuedAtTimeSeconds"] = this.issuedAtTimeSeconds;
        data["uid"] = this.uid;
