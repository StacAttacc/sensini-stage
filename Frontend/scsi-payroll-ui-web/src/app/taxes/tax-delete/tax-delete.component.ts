...
import { ISocialContributionEmployee, SocialContributionService } from 'src/app/services/payroll-api-proxy';
...
export class TaxDeleteComponent {
  ...
  delete(){
    this.socialContributionService.socialContributionEmployeeDeleteById(this.data.id).subscribe( tax => {
  ...
  ngOnInit():void{
    ...
    this.socialContributionService.socialContributionEmployeeById(this.data.id).subscribe(res => {
